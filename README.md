...
researcher = {
    "name"      : "Daniel Harrod",
    "focus"     : ["Healthcare AI", "Defense Tech", "Neuromorphic Computing"],
    "mission"   : "Apply machine intelligence where getting it wrong has real consequences",
...
> *I'm drawn to problems where the model ships, operates under constraint, and has to be right.*
...
- End-to-end automation of diagnostic AI workflows
...
- Adversarial robustness & model integrity under distribution shift
...
- Data-scarce regimes — few-shot, semi-supervised learning
...
Real-time object detection pipeline using **Spiking Neural Networks** (SpikingJelly) deployed on **NVIDIA Jetson** edge hardware. Investigating energy-efficient, biologically-inspired inference architectures for constrained surveillance and autonomous systems applications. Parallel workstream applying Meditron's clinical **LLMs to COVID-19 data** within the lab's medical AI pipeline.

`SpikingJelly` `NVIDIA Jetson` `SNN` `Real-Time Detection` `Neuromorphic Computing` `Edge Inference` `Meditron` `Clinical LLM`
...
<img height="175em" src="https://github-profile-summary-cards.vercel.app/api/cards/stats?username=Daniel-Harrod13&theme=2077" />
<img height="175em" src="https://github-profile-summary-cards.vercel.app/api/cards/most-commit-language?username=Daniel-Harrod13&theme=2077" />

<br/>

<img height="175em" src="https://github-profile-summary-cards.vercel.app/api/cards/repos-per-language?username=Daniel-Harrod13&theme=2077" />
<img height="175em" src="https://github-profile-summary-cards.vercel.app/api/cards/productive-time?username=Daniel-Harrod13&theme=2077&utcOffset=-7" />
